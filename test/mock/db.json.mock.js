	...
	angular.module("noinfopath.data.mocks", [])
		.value("dbJsonMock", {
			store: {
				...
				"CoolerTrials": "$$CoolerTrialID,HarvestID,FirmnessID,FlavorID,UserID",
				"Harvests": "$$HarvestID,ActionID,HarvestWeightUOMID,UserID,TrialPlotID",
				"LU_Firmness": "$$FirmnessID",
				"LU_Flavor": "$$FlavorID",
				"Selections": "$$SelectionID,FamilyID,GenusID,SpeciesID,StageID,UserID,SeedlingPlotID"
			},
			request: {
				method: "GET",
				url: "/db.json",
