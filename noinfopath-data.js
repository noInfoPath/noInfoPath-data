...
(function(angular,undefined){
	...
	angular.module('noinfopath.data', ['noinfopath.data.init','xc.indexedDB']),
		...
		.provider('noDB', [function() {
			...
			this.$get = [
				...
				'NOSYNC_CONSTANTS',
				'noDbInit',
				function($q, $window, $http, $indexedDB, NODB, log,$rootScope, noStatus, NOSYNC,init){
