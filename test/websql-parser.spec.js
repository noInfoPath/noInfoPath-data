describe("Testing noWebSQLParser", function () {
	...
	describe("Testing SQL conversion functions", function () {
		...
		it("_interface should exist", function () {
			expect(noWebSQLParser._interface)
				.toBeDefined();
			expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions)
				.toBeDefined();
			expect(noWebSQLParser._interface.toSqlLiteConversionFunctions)
				.toBeDefined();
			expect(noWebSQLParser._interface.sqlConversion)
				.toBeDefined();
		});
		...
		describe("Testing toSqlLiteConversionFunctions conversion functions", function () {
			...
			it("Testing TEXT with proper datatype, expecting a string", function () {
				expect(noWebSQLParser._interface.toSqlLiteConversionFunctions.TEXT)
					.toBeDefined();
				var result,
					input = "Test String",
			...
			it("Testing BLOB with proper datatype, expecting a blob", function () {
				expect(noWebSQLParser._interface.toSqlLiteConversionFunctions.BLOB)
					.toBeDefined();
				var result,
					input = "IMABLOB",
					expected = "IMABLOB";
			...
			it("Testing INTEGER with proper datatype, expecting an integer", function () {
				expect(noWebSQLParser._interface.toSqlLiteConversionFunctions.INTEGER)
					.toBeDefined();
				var result,
					input = 15,
					expected = 15;
			...
			it("Testing NUMERIC with proper datatype, expecting a numeric", function () {
				expect(noWebSQLParser._interface.toSqlLiteConversionFunctions.NUMERIC)
					.toBeDefined();
				var result,
					input = 15.5,
					expected = 15.5;
			...
			it("Testing REAL with proper datatype, expecting a real", function () {
				expect(noWebSQLParser._interface.toSqlLiteConversionFunctions.REAL)
					.toBeDefined();
				var result,
					input = "IMAREAL",
					expected = "IMAREAL";
		...
		describe("Testing fromSqlLiteConversionFunctions conversion functions", function () {
			...
			it("Testing bigint with proper datatype and value, expecting an int to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.bigint)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing bit with proper datatype and value, expecting an int to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.bit)
					.toBeDefined();
				var result,
					input = 1,
					expected = 1;
			...
			it("Testing decimal with proper datatype and value, expecting a decimal to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.decimal)
					.toBeDefined();
				var result,
					input = 10.2,
					expected = 10.2;
			...
			it("Testing int with proper datatype and value, expecting an int to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.int)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing money with proper datatype and value, expecting a decimal to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.money)
					.toBeDefined();
				var result,
					input = 10.2,
					expected = 10.2;
			...
			it("Testing numeric with proper datatype and value, expecting a decimal to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.numeric)
					.toBeDefined();
				var result,
					input = 10.2,
					expected = 10.2;
			...
			it("Testing smallint with proper datatype and value, expecting an int to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.smallint)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing smallmoney with proper datatype and value, expecting a decimal to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.smallmoney)
					.toBeDefined();
				var result,
					input = 10.2,
					expected = 10.2;
			...
			it("Testing tinyint with proper datatype and value, expecting an int to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.tinyint)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing float with proper datatype and value, expecting a real to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.float)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing real with proper datatype and value, expecting an real to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.real)
					.toBeDefined();
				var result,
					input = 10,
					expected = 10;
			...
			it("Testing date with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.date)
					.toBeDefined();
				var result,
			...
			xit("Testing date without proper datatype and value, expecting a new UTC date to be returned", function () {
				...
				expect(result)
					.toBeCloseToTime(expected);
			});

			it("Testing datetime with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.datetime)
					.toBeDefined();
				var result,
					input = new Date(2015, 08, 18, 10, 30, 50, 100),
					expected = 1441449050100;
			...
			it("Testing datetime2 with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.datetime2)
					.toBeDefined();
				var result,
					input = new Date(2015, 08, 18, 10, 30, 50, 100),
					expected = 1441449050100;
			...
			it("Testing datetimeoffset with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.datetimeoffset)
					.toBeDefined();
				var result,
					input = new Date(2015, 08, 18, 10, 30, 50, 100),
					expected = 1441449050100;
			...
			it("Testing smalldatetime with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.smalldatetime)
					.toBeDefined();
				var result,
					input = new Date(2015, 08, 18, 10, 30, 50, 100),
					expected = 1441449050100;
			...
			it("Testing time with proper datatype and value, expecting a UTC date to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.time)
					.toBeDefined();
				var result,
					input = new Date(2015, 08, 18, 10, 30, 50, 100),
					expected = 1441449050100;
			...
			it("Testing char with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.char)
					.toBeDefined();
				var result,
					input = "a",
					expected = "a";
			...
			it("Testing nchar with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.nchar)
					.toBeDefined();
				var result,
					input = "d",
					expected = "d";
			...
			it("Testing varchar with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.varchar)
					.toBeDefined();
				var result,
					input = "10",
					expected = "10";
			...
			it("Testing nvarchar with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.nvarchar)
					.toBeDefined();
				var result,
					input = "foo",
					expected = "foo";
			...
			it("Testing text with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.text)
					.toBeDefined();
				var result,
					input = "hello",
					expected = "hello";
			...
			it("Testing ntext with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.ntext)
					.toBeDefined();
				var result,
					input = "goodbye",
					expected = "goodbye";
			...
			it("Testing binary with proper datatype and value, expecting a blob to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.binary)
					.toBeDefined();
				var result,
					input = "BLOB",
					expected = "BLOB";
			...
			it("Testing varbinary with proper datatype and value, expecting a blob to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.varbinary)
					.toBeDefined();
				var result,
					input = "BLOB",
					expected = "BLOB";
			...
			it("Testing image with proper datatype and value, expecting a blob to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.image)
					.toBeDefined();
				var result,
					input = "BLOB",
					expected = "BLOB";
			...
			it("Testing uniqueidentifier with proper datatype and value, expecting a string to be returned", function () {
				expect(noWebSQLParser._interface.fromSqlLiteConversionFunctions.uniqueidentifier)
					.toBeDefined();
				var result,
					input = "GUID",
					expected = "GUID";
